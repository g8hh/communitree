...
var cnItems = {
    ...
    'e38000 despacit points': 'e38000 despacit点',
    'Gacha Mergables': '扭蛋可合并',
    'Unlocks Gacha Mergables.': '解锁扭蛋可合并。',
    '(v2.0)\n                    The next update unlocks new upgrades.\n                \n                    Diff: 1e1,000,000': '(v2.0)\n                    下一次更新解锁新的升级.\n                \n                    差异: 1e1,000,000',
    'CHAINED ARROWS': '链式箭头',
    'FALLBACK NOTATION': '回退符号',
    'FGH-J NOTATION': 'FGH-J 符号',
    'HYPER-E': '超级E',
    'Saving': '保存',
    'Display': '显示',
    'Based on your gacha count': '根据您的扭蛋数量',
    'Based on your merge field rows': '基于您的合并字段行',
    'bonus tiers\n\t\t\t\t': '奖励层\n\t\t\t\t',
    'Gacha Mergeyard': '扭蛋合并场',
    'Giftcode Generator': '礼品代码生成器',
    'Pressing on Mergeyard will now spend the most amount of mergents until the next upgrade.': '现在按下 合并场 将花费最多的合并，直到下一次升级。',
    'Unlocks the Giftcode Generator, which is the next tab of the layer.': '解锁礼品代码生成器，这是层的下一个选项卡。',
    'Your bonus special chance is 15.00%.': '您的奖金特殊机会为 15.00%。',
    'These are all the available giftcodes that I managed to find': '这些是我设法找到的所有可用礼品码',
    'Type \"help\" for a list of commands.': '键入 \"help\" 以获取命令列表。',
    'Unlocks the Giftcode Hunter minigame. Type \"run giftcode hunter\" to start.': '解锁 礼品码猎人 迷你游戏。 输入“run giftcode hunter” 开始。',
    'Giftcode Macros': '礼品码宏',
    'Giftcodes': '礼品码',
    'I dont know what \"yadmir2164\" means.': '我不知道“yadmir2164”是什么意思。',
    'Keep Grinding': '继续打磨',
    'Loyal Player': '忠实玩家',
    'Mods, for real': '模组，真的',
    'Flame Master': '火焰大师',
    'Giftcode Hunter': '礼品码猎人',
    'Conveyor Belts': '输送带',
    'All known YCDAYWTD gift codes': '所有已知的 YCDAYWTD 礼品代码',
    'APTMAM: Rewritten': 'APTMAM：重写',
    'Auto-Gacha-Merge': '自动扭蛋合并',
    'Automates': '自动化',
    'Automator': '自动机',
    'Automator II': '自动机 II',
    'gift points.': '礼品点数。',
    'All known YCDAYWTD gift codes': '所有已知的 YCDAYWTD 礼品代码',
    'The Present Tree': '当前树',
    "if the site stopped loading and you still see this message something bad must've happened!": "如果网站停止加载，你仍然看到这个消息，一定是发生了什么不好的事情！",
    "Now Loading...": "正在加载...",
    "Game saved.": "游戏已保存。",
    "": "",
    "": "",
...
var cnPrefix = {
    ...
    "Synthesis: ": "合成: ",
    "Tree: ": "树: ",
    "Large Number Format: ": "大数格式：",
    "Gachapon:": "扭蛋:",
    "News Ticker: ": "新闻播报: ",
    "Small Number Format: ": "小数字格式: ",
    "": "",
    "": "",
    "": "",
    "": "",
...
//	[/^Cost: (.+) points\n\t\t\t$/, '成本: $1 点数\n\t\t\t'],
	...
	[/^Your bonus special chance is (.+)\%.$/, '您的奖金特殊几率是 $1\%。'],
	[/^enhance points\n(.+)Next at ee(.+)$/, '加强点\n$1下一个在ee$2'],
	[/^time capsules\n(.+)Next at ee(.+)$/, '时间胶囊\n$1下一个在ee$2'],
	[/^subspace energy\n(.+)Next at ee(.+)$/, '子空间能量\n$1下一个在ee$2'],
