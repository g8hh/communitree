...
var cnItems = {
    ...
    'Boosts mergent gain based on your power tokens and life tokens.': '根据您的动力代币和生命代币提高合并增益。',
    'Boosts mergent gain based on your power tokens.': '根据您的动力代币提高合并增益。',
    ...
    'Unlocks Power Mergeyard.': '解锁动力合并场。',
    'Unlocks the': '解锁',
    ...
    'Despacit effect boosts golden mergent gain.': 'Despacito 效应提高了黄金合并增益。',
    ...
    'Produces power tokens based on golden mergents.': '生产基于金色合并的动力代币。',
    ...
    'special mergable, which is based on your despacit point effect.': '特殊可合并，这是基于你的despacit点效应。',
    ...
    'special mergable, which is based on your power tokens.': '特殊可合并，基于你的动力代币。',
...
var cnRegReplace = new Map([
	...
	[/^\+(.+) mergent multi based on your magnet upgrade$/, '\+$1 个基于 磁铁升级 的合并乘数'],
	[/^\+(.+) mergent multi based on despacit mods$/, '\+$1 个基于 depacit模组 的合并乘数'],
	[/^\+(.+) mergent multi based on merge level$/, '\+$1 个基于 合并等级 的合并乘数'],
	[/^\+(.+) accelerons per second$/, '\+$1 加速器每秒'],
	[/^\+(.+) mergent multi based on your spawning tier$/, '\+$1 个基于 生产层 的合并乘数'],
...
//	[/^Cost: (.+) points\n\t\t\t$/, '成本: $1 点数\n\t\t\t'],
	...
	[/^(.+)\n(.+)Each star gives a 10× boost to mergent gain!\n(.+)Currently: (.+)\n\n(.+)Cost: (.+) golden mergents\n(.+)Note: This is not refundable!$/, '$1\n 每颗星都为合并增益提供 10 倍的提升！\n当前: $4\n\n 成本: $6 金色合并\n注意：此操作不可回退！'],
