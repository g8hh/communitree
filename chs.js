...
var cnItems = {
    ...
    'ashes, which produces thefinaluptake points.': '灰烬，产生最终吸收点。',
    ...
    'thefinaluptake (α) points': '最终吸收 (α) 点',
    ...
    'ashes, which produce thefinaluptake points.': '灰烬，产生最终的吸收点。',
    ...
    'Bars.': '条.',
    'Boost to dev speed based on thefinaluptake time.': '根据最终摄取时间提升到开发速度。',
    'Burn the Game': '燃烧游戏',
    'Fasten the Game': '抓紧游戏',
    'Fasten thefinaluptake time based on component points.': '根据组件点加快最终吸收时间。',
    'Fasten thefinaluptake time based on previous upgrade.': '在之前的升级基础上缩短最终的吸收时间。',
    ...
    'Multiplier': '倍数',
    'Normal': '正常',
    'which are making thefinaluptake time 1,362× faster.': '这使最终摄取时间快了 1,362 倍。',
    'Golden Mergant': '金色合并',
    'Producer Tree': '生产者树',
...
var cnRegReplace = new Map([
	...
	[/^Q: ×(.+), H: ×(.+)$/, 'Q: ×$1, H: ×$2'],
	[/^ee(.+) thefinaluptake points$/, 'ee$1 最终吸收点'],
	[/^ee(.+) thefinaluptake \(α\) points$/, 'ee$1 最终吸收\(α\)点'],
	...
	[/^which are making thefinaluptake time (.+)× faster.$/, '这使最终摄取时间快了 $1 倍。'],
