...
var cnItems = {
    ...
    'Boosts golden mergent gain based on your bonus despacit mods.': '根据您的额外 despacit 模块 提高黄金合并增益。',
    'Boosts mergent gain based on your amount of': '提高合并增益基于您的数量关于',
    'Boosts mergent gain based on your bonus despacit mods.': '根据您的额外 despacit 模块 提高合并增益。',
    ...
    'Unlocks Power Mergeyard.': '解锁能源合并场。',
    'Unlocks the': '解锁',
...
var cnRegReplace = new Map([
	...
	[/^(.+) mergents, which are giving (.+) bonus despacit mods.$/, '$1 合并，提供 $2 奖励的Despacit模块。'],
	[/^(.+) despacit mods, which are producing (.+) despacit points.$/, '$1 Despacit模块，产生 $2 Despacit点。'],
