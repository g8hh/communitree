...
var cnItems = {
    ...
    'You can buy max Boosters and Generators.': '您可以购买最大的助推器和发电机。',
    'True Prestige Tree': '真声望树',
    'Booster and Generator resets no longer reset.': '助推器和发电机重置不再重置。',
    'Booster Generators': '助推器发电机',
    'Boosters and Generators are claimed automatically.': '助推器和发电机会自动领取。',
    'Generator Boosters': '发电机助推器',
    'It Gets Better': '变得更好了',
    'Let there be Life!': '要有生命！',
    'Lossless Conversion': '无损转换',
    'Makes Boosters and Generators boost points.': '使助推器和发电机提升点数。',
    'Points decrease the cost of Boosters and Generators.': '点数降低了助推器和发电机的成本。',
    'Quick Cash': '快速赚钱',
    'Real Prestige Tree': '真正的声望树',
    'Supercharge': '超负荷',
    'Boosters increase the speed of Generators by +2.5% each, up to +25×.': '每个助推器增加发电机的速度+2.5%，最多 +25x。',
    'Generators increase the multiplier per each booster by +.8% each, up to +3.': '发电机将每个助推器的乘数增加 +0.8%，最多 +3。',
    '': '',
    '': '',
    '': '',
    '': '',
