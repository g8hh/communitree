...
var cnItems = {
    ...
    'Quirk and Hindrance Spirits boosts each other\'s gain.': '怪癖和阻碍精神会提高彼此的收益。',
    'Quirkier': '更为离奇',
    'Row 4 Synergy': '第 4 行协同作用',
    'Super-Booster effect multiplies Hindrance Spirit gain.': '超级助推器效果乘以阻碍精神增益。',
    'Super-Boosters no longer resets, gets auto-claimed and you can buy max them.': '超级助推器不再重置，自动领取，您可以购买最多。',
    'Super-Generators no longer resets and are auto-buy^2-max^2-able.': '超级发电机不再重置并且可以自动购买^2-max^2-able',
    'The quirks in the quirk formula increases from ^0.6 to ^1 in 120 seconds in this Jacorb reset.': '在此 Jacorb 重置中，怪癖公式中的怪癖在 120 秒内从 ^0.6 增加到 ^1。',
    ...
    '^0.02 of your Generator and Booster effect multiplies the first four upgrades\' effects.': '^0.02 的发电机和助推器效果乘以前四个升级的效果。',
    ...
    '^10 of your Quirk effect multiplies the first four upgrades\' effects.': '^10你的怪癖效果乘以前四个升级的效果。',
